...
class TestApiGetListMessage:
    ...
    def test_api_get_list_message_successfully(self):
        title = "New Thread"
        ...
        log_response(json_data, "test_api_get_list_message_successfully")
        ...
        log_response(json_data_new_message, "test_api_get_list_message_successfully")
        assert_equal(new_message_response.status_code,200)
        
        # Get list message
        list_message_response = requests.get(message_url)
        json_data_list_message = list_message_response.json()
        log_response(json_data_list_message, "test_api_get_list_message_successfully")
        assert_equal(list_message_response.status_code,200)
        ...
        jsonschema.validate(instance=json_data_list_message, schema=schema)
        
        assert_equal(json_data_list_message["data"][0]["content"][0]['text']["value"], "Hello, world!")