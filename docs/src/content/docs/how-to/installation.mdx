...
|----------|--------------|-------------------|
| macOS | [Download](https://app.cortexcpp.com/download/latest/mac-universal-local) | 1. Open the .pkg file<br/>2. Follow the installer wizard |
| Linux | [Download](https://app.cortexcpp.com/download/latest/linux-amd64-local) | Run: `curl -s https://raw.githubusercontent.com/menloresearch/cortex/main/engine/templates/linux/install.sh \| sudo bash -s` |
| Windows | [Download](https://app.cortexcpp.com/download/latest/windows-amd64-local) | 1. Run the installer<br/>2. Follow the setup wizard |

<Aside>
Looking for beta or nightly builds? Check the [release channels](#release-channels) section below.
</Aside>
